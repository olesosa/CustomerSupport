...
public class DataSeeder
{
    ...
    public void SeedUsers()
    {
        ...
        {
            new() { Id = userId1, Email = "userEmail1@email.com", RoleName = "User", },
            new() { Id = userId2, Email = "userEmail2@email.com", RoleName = "User" },
            new() { Id = userId3, Email = "userEmail3@email.com", RoleName = "User" },
            new() { Id = adminId, Email = "adminEmail1@email.com", RoleName = "Admin" }
        };
